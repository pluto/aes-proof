...
describe("aes-gcm", () => {
  let circuit: WitnessTester<["key", "iv", "plainText", "additionalData"], ["cipherText", "tag"]>;
...
//   let HashKey = [0x66,0xe9,0x4b,0xd4,0xef,0x8a,0x2c,0x3b,0x88,0x4c,0xfa,0x59,0xca,0x34,0x2b,0x2e];
  let additionalData = [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00];
  ...
  it("should have correct output", async () => {
    const witness = await circuit.compute({ key: key, iv: iv, plainText: plainText, additionalData: additionalData }, ["cipherText", "authTag"])
